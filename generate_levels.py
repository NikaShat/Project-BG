...
def generate_level(level, tiles_group, all_sprites, level_num):
    if level_num == 1:
        for y in range(len(level)):
            for x in range(len(level[y])):
                if level[y][x] == 'x':
                    ...
                    Tile('earth', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '*':
                    Tile('heart', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == 'r':
                    Tile('river', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == 'b':
                    Tile('bridge', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '^':
                    Tile('forest', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '$':
                    Tile('money', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '+':
                    Tile('mountain', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '!':
                    Tile('exit', x, y, 1, tiles_group, all_sprites)
    elif level_num == 2:
        for y in range(len(level)):
            for x in range(len(level[y])):
                if level[y][x] == 'x':
                    ...
                    Tile('sand', x, y, 2, tiles_group, all_sprites)
                elif level[y][x] == '*':
                    Tile('heart', x, y, 2, tiles_group, all_sprites)
                elif level[y][x] == '^':
                    Tile('ruins', x, y, 2, tiles_group, all_sprites)
                elif level[y][x] == 'b':
                    Tile('bridge', x, y, 2, tiles_group, all_sprites)
                elif level[y][x] == '=':
                    Tile('cliff', x, y, 2, tiles_group, all_sprites)
                elif level[y][x] == '$':
                    Tile('money', x, y, 2, tiles_group, all_sprites)
                elif level[y][x] == '+':
                    Tile('mountain', x, y, 2, tiles_group, all_sprites)
                elif level[y][x] == '%':
                    Tile('plant', x, y, 2, tiles_group, all_sprites)
                elif level[y][x] == '!':
                    Tile('exit', x, y, 2, tiles_group, all_sprites)
    else:
        for y in range(len(level)):
            for x in range(len(level[y])):
                if level[y][x] == 'x':
                    ...
                    Tile('swamp', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '*':
                    Tile('heart', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '+':
                    Tile('wall', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == 'b':
                    Tile('earth', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '^':
                    Tile('bridge', x, y, 1, tiles_group, all_sprites)
                    ...
                    Tile('crack', x, y, 1, tiles_group, all_sprites)
                elif level[y][x] == '!':
                    Tile('exit', x, y, 1, tiles_group, all_sprites)
...
tile_images_level2 = {'cantgo': load_image.loadimage('image_level2/cantgo2.png'),
                      ...
                      'ruins': load_image.loadimage('ruins.png'),
...
class Tile(pygame.sprite.Sprite):
    def __init__(self, tile_type, pos_x, pos_y, level_num, tiles_group, all_sprites):
